...
export const MODEL_LIST: ModelEntry[] = [
  ...
  { id: "keycap-r1",   name: "键帽 R1",    description: "数字行 — 最高 11.2mm，前倾 3°", component: <KeycapModel row={1} /> },
  { id: "keycap-r2",   name: "键帽 R2",    description: "QWERTY 行 — 9.4mm，前倾 6°",   component: <KeycapModel row={2} /> },
  { id: "keycap-r3",   name: "键帽 R3",    description: "Home 行 — 最矮 9.0mm，前倾 9°",component: <KeycapModel row={3} /> },
  { id: "keycap-r4",   name: "键帽 R4",    description: "底行 — 9.6mm，前倾 2°",         component: <KeycapModel row={4} /> },
  ...
  { id: "keycap-625u", name: "键帽 6.25u", description: "Space (R4)",                    component: <KeycapModel wu={6.25} row={4} color="#ddeeff" /> },
];
